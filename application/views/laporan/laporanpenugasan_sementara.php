            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        Penugasan Karyawan
                        (Laporan Penugasan Karyawan Sementara)</h5>
                ...
                <div class="panel-body">
                    ...
                    if ($ceks->level == "hrd" || $ceks->level == "admin") { ?>
                        <div class="cols-md-12">
                            <a href="web/penugasan_sementara_csv/" title="CSV">Cetak Laporan Excel</a>
                        </div>
                    <?php
                    } ?>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($v_laporanpenugasan->result() as $baris) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="web/laporanpenugasan_sementara_pdf/<?php echo $baris->id_penugasan; ?>" title="Print"><span class="icon-printer2"></span></a>
                                    </td>
