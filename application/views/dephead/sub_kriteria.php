          ...
          <form class="form-horizontal" action="" method="post">
            <div class="col-md-12">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="sub_kriteria" class="form-control" value="" required maxlength="35" placeholder="Nama Sub Kriteria">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                  <input type="number" min="1" max="5"  name="nilai_sub_kriteria" class="form-control" value="" required maxlength="35" placeholder="Nilai (1-5)">
                 </div>
                </div>
          ...
          <table class="table datatable-basic" width="100%">
            ...
            <tbody>
              ...
              foreach ($v_sub_kriteria->result() as $baris) {
                ?>
              <tr>
                <td><?php echo $baris->id_sub_kriteria; ?></td>
                <td><?php echo $baris->nama_kriteria; ?></td>
                <td><?php echo $baris->nama_sub_kriteria; ?></td>
                <td><?php echo $baris->nilai_sub_kriteria; ?></td>
               
                <?php
                  if ($ceks->level == "director"|| $ceks->level == "admin" || $ceks->level == "hrd") { ?>
                <td>
                  <a href="web/sub_kriteria_edit/<?php echo $baris->id_sub_kriteria; ?>" title="Edit"><span class="icon-pencil"></span></a> &nbsp;
                  <a href="web/sub_kriteria_hapus/<?php echo $baris->id_sub_kriteria; ?>" title="Hapus" onclick="return confirm('Apakah Anda yakin?')"><span class="icon-trash"></span></a>
                </td>
                <?php
                  } ?>
              </tr>
