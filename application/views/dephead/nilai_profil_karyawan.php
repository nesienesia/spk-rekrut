              ...
              <div class="col-md-12">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control" name="id_sub_kriteria" onchange="changeValue(this.value)" autofocus>
                        ...
                        foreach ($v_sub_kriteria->result() as $baris) {
                          echo '<option value="' . $baris->id_sub_kriteria . '">' . "$baris->nama_kriteria - [$baris->nama_sub_kriteria] - ($baris->nilai_sub_kriteria)" . '</option>';
                      ...
                      <script type="text/javascript">
                        ...
                        function changeValue(id) {
                          ...
                          document.getElementById('nilai_sub_kriteria').value = dtKamar[id].nilai_sub_kriteria;
                        };
                      </script>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="number" min="1" max="5" id="nilai_sub_kriteria" name="nilai_profil_karyawan" class="form-control" value="" required maxlength="35" placeholder="Nilai (1-5)">
                    </div>
                  </div>
