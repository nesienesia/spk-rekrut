          ...
          <form class="form-horizontal" action="" method="post">
            <div class="col-md-12">
              ...
              <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control" name="id_persetujuan" onchange="changeValue(this.value)" autofocus>
                        <option value="">Pilih Permintaan</option>
                        <?php
                          $jsArray = "var dtKamar = new Array();\n";
                          foreach ($v_persetujuan->result() as $baris) {

                            echo '<option value="' . $baris->id_persetujuan . '">' . "$baris->seksi - $baris->jabatan [$baris->persetujuan_ptk]" . '</option>';
                            $jsArray .= "dtKamar['" . $baris->id_persetujuan . "'] = {
                                        id_persetujuan:'" . addslashes($baris->id_persetujuan) . "'
                                      };\n";
                          } ?>
                      </select>
                      <script type="text/javascript">
                        ...
                        function changeValue(id) {
                          document.getElementById('id_persetujuan').value = dtKamar[id].id_persetujuan;
                        };
                      </script>
                    </div>
                  </div>
          ...
          <table class="table datatable-basic" width="100%">
            ...
            <tbody>
              ...
              foreach ($v_realisasiptk->result() as $baris) {
                ?>
              <tr>
                <td><?php echo $baris->id_realisasi ?></td>
                ...
                <?php
                  if ($ceks->level == "hrd" || $ceks->level == "admin") { ?>
                <td>
                  <a href="web/realisasiptk_edit/<?php echo $baris->id_realisasi; ?>" title="Edit"><span class="icon-pencil"></span></a> &nbsp;
                  <a href="web/realisasiptk_hapus/<?php echo $baris->id_realisasi; ?>" title="Hapus" onclick="return confirm('Apakah Anda yakin?')"><span class="icon-trash"></span></a> &nbsp;
                </td>
                <?php
                  } ?>
              </tr>
