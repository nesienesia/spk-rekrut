        ...
        <table class="table datatable-basic" width="100%">
          ...
          <tbody>
            ...
            foreach ($v_persetujuan->result() as $baris) {
              ?>
              <tr>
                <td><?php echo $baris->id_persetujuan; ?></td>
                ...
                <?php
                  if ($ceks->level == "director" || $ceks->level == "admin" || $ceks->level == "hrd") { ?>
                  <td>
                    <a href="web/persetujuanptk_edit/<?php echo $baris->id_persetujuan; ?>" title="Edit"><span class="icon-pencil"></span></a> &nbsp;
                    <a href="web/persetujuanptk_hapus/<?php echo $baris->id_persetujuan; ?>" title="Hapus" onclick="return confirm('Apakah Anda yakin?')"><span class="icon-trash"></span></a>
                  </td>
                <?php
                  } ?>
              </tr>
