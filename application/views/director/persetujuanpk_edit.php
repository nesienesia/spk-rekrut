      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="radio" name="persetujuan_pk" value="Setuju" <?php if ($v_persetujuan->persetujuan_pk == 'Setuju') {
                                                                            echo 'checked';
                                                                          } ?>> Setuju<br>
                    <input type="radio" name="persetujuan_pk" value="Tidak" <?php if ($v_persetujuan->persetujuan_pk == 'Tidak') {
                                                                            echo 'checked';
                                                                          } ?>> Tidak<br>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <textarea name="ket_stj_pk" rows="8" cols="80" class="form-control" placeholder="Keterangan" required> <?php echo $v_persetujuan->ket_stj_pk;?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="text" name="pic_pk" class="form-control" value="<?php echo $v_persetujuan->pic_pk;?>" required maxlength="35" placeholder="PIC Persetujuan">
                    </div>
                  </div>
            ...
            <br>
            <hr>
            <a href="web/persetujuanpk" class="btn btn-default">Back</a>
