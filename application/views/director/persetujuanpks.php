              ...
              <div class="col-md-12">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="radio" name="persetujuan_pks" value="Setuju" required> Setuju<br>
                      <input type="radio" name="persetujuan_pks" value="Tidak" required> Tidak Setuju<br>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <textarea name="ket_stj_pks" rows="8" cols="80" class="form-control" placeholder="Keterangan" required></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="text" name="pic_pks" class="form-control" value="" required maxlength="35" placeholder="PIC Persetujuan">
                    </div>
                  </div>
        ...
        <table class="table datatable-basic" width="100%">
          ...
          <tbody>
            ...
            foreach ($v_persetujuan->result() as $baris) {
              ?>
              <tr>
                <td><?php echo $baris->kd_persetujuanpks; ?></td>
                ...
                <td><?php echo $baris->persetujuan_pks; ?></td>
                <td><?php echo $baris->ket_stj_pks; ?></td>
                <td><?php echo $baris->pic_pks; ?></td>
                <td><?php echo $baris->menerima; ?></td>
                <td><?php echo $baris->mengetahui; ?></td>
                <?php
                  if ($ceks->level == "director" || $ceks->level == "admin" || $ceks->level == "hrd") { ?>
                  <td>
                    <a href="web/persetujuanpks_edit/<?php echo $baris->kd_persetujuanpks; ?>" title="Edit"><span class="icon-pencil"></span></a> &nbsp;
                    <a href="web/persetujuanpks_hapus/<?php echo $baris->kd_persetujuanpks; ?>" title="Hapus" onclick="return confirm('Apakah Anda yakin?')"><span class="icon-trash"></span></a>
                  </td>
                <?php
                  } ?>
              </tr>
